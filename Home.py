...
st.page_link("pages/03_Analisis_Temporal_Fatal.py",label=" -> Ir al Análisis Temporal de Fatalidades")
st.page_link("pages/04_Analisis_Temporal_No_Fatal.py",label=" -> Ir al Análisis Temporal de Lesiones")
st.page_link("pages/05_Analisis_por_Victima_Fatal.py",label=" -> Ir al Análisis por víctima fatal")
st.page_link("pages/06_Analisis_por_Victima_No_Fatal.py",label=" -> Ir al Análisis por víctima no fatal")
st.page_link("pages/07_Analisis_Geografico_Fatal.py", label=" -> Ir al Mapa de Hechos Fatales")
