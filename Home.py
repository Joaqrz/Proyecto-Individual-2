...
st.page_link("pages/04_Analisis_por_Victima_Fatal.py",label=" -> Ir al Análisis por víctima fatal")
st.page_link("pages/05_Analisis_por_Victima_No_Fatal.py",label=" -> Ir al Análisis por víctima no fatal")
