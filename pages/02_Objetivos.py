...
st.page_link('pages/01_Contexto.py',label='⬅️ Anterior: Contexto')
st.title('Objetivos')
...
st.write('* Reducir en un 10% la tasa de homicidios en siniestros viales de los últimos 6 meses, en comparación con el semestre anterior.')
...
st.page_link('pages/03_Analisis_Temporal_Fatal.py',label='➡️ Siguiente: Análisis Temporal Fatal')
st.divider()